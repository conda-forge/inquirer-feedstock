...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/inquirer-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=9102&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/inquirer-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `inquirer` can be installed with:

```
conda install inquirer
```

It is possible to list all of the versions of `inquirer` available on your platform with:
